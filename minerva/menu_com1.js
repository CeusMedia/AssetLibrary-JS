...
function CreateMenuStructure(MName,NumberOf){
	...
	if(DomYes){
		...
		Location.document.body.appendChild(MmbrCntnr)}
			...
			Location.document.body.insertAdjacentHTML("AfterBegin","<div id='"+WMnu+"' style='visibility:hidden; position:relative;'><\/div>");
	...
	if(Exp4){	MmbrCntnr.InnerString='';
		for(i=1;i<NumberOf+1;i++){
			WMnu=MName+eval(i);
			MmbrCntnr.InnerString+="<div id='"+WMnu+"' style='position:relative;'><\/div>"}
